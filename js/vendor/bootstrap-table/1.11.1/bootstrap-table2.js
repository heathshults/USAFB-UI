...
(function ($) {
  ...
  var compareObjects = function (objectA, objectB, compareLength) {
    ...
    var objectBProperties = Object.getOwnPropertyNames(objectB)
    var propName = ''
    ...
    for (i < objectAProperties.length; i++) {
  ...
  var isIEBrowser = function () {
    return Boolean(navigator.userAgent.indexOf('MSIE ') > 0 || Boolean(navigator.userAgent.match(/Trident.*rv\:11\./)))
    }
              ...
              for (var j = 0; j < that.header.fields.length; j++) {
                  ...
                  if (typeof value === 'string' || typeof value === 'number') {
                      if (that.options.strictSearch) {
                          if (String(value).toLowerCase() === s) {
                              return true
                            }
                        } else if ((String(value)).toLowerCase().indexOf(s) !== -1) {
                                return true
                            }
                    }
                }
        ...
        if (!this.options.onlyInfoPagination) {
              ...
              var list = this.options.pageList.replace('[', '').replace(']', '')
                ...
                $.each(list, (i, value) => {
                    pageList.push(value.toUpperCase() === that.options.formatAllRows().toUpperCase() ?
                        that.options.formatAllRows() : Number(value))
                })
            }
          ...
          if (this.totalPages >= 6) {
              if (this.options.pageNumber >= 3) {
                  html.push(`<li class="page-first${this.options.pageNumber === 1 ? ' active' : '' }">`,
                        '<a href="#">', 1, '</a>',
                        '</li>')
...
that.$tableLoading.hide()}
  ...
  BootstrapTable.prototype.getAllSelections = function () {
    ...
    return $.grep(this.options.data, (row) => row[that.header.stateField])
  }
  ...
  BootstrapTable.prototype.getHiddenColumns = function () {
    return $.grep(this.columns, (column) => !column.visible)
  }
