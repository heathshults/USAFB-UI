  ...
  $.fn.extend({
    tableExport: function (options) {
      ...
      if ( defaults.type == 'csv' || defaults.type == 'tsv' || defaults.type == 'txt' ) {
        ...
        try {
          blob = new Blob([tdData], {type: "text/plaincharset=utf-8"})
          saveAs(blob, defaults.fileName + '.sql')
        }
        catch (e) {
          downloadFile(defaults.fileName + '.sql',
            'data:application/sqlcharset=utf-8,',
            tdData)
        }
        ...
        try {
          blob = new Blob([sdata], {type: "application/jsoncharset=utf-8"})
          saveAs(blob, defaults.fileName + '.json')
        }
        catch (e) {
          downloadFile(defaults.fileName + '.json',
            'data:application/jsoncharset=utf-8base64,',
            sdata)
        }
        ...
        try {
          blob = new Blob([xml], {type: "application/xmlcharset=utf-8"})
          saveAs(blob, defaults.fileName + '.xml')
        }
        catch (e) {
          downloadFile(defaults.fileName + '.xml',
            'data:application/xmlcharset=utf-8base64,',
            xml)
        }
      }
        ...
        try {
          blob = new Blob([xmlssDocFile], {type: "application/xmlcharset=utf-8"})
          saveAs(blob, defaults.fileName + '.xml')
        }
        catch (e) {
          downloadFile(defaults.fileName + '.xml',
        ...
        try {
          blob = new Blob([jx_s2ab(wbout)], {type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheetcharset=UTF-8'})
          saveAs(blob, defaults.fileName + '.' + defaults.type)
        }
        catch (e) {
          downloadFile(defaults.fileName + '.' + defaults.type,
            'data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheetcharset=UTF-8,',
            jx_s2ab(wbout))
        }
