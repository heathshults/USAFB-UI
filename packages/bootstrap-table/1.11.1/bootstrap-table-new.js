  ...
  BootstrapTable.prototype.onSort = function (event) {
    ...
    if (this.options.sortName === $this.data('field')) {
      ...
      if (this.options.rememberOrder) {
        ...
        this.options.sortOrder = this.options.columns[0].filter((option) => {
  ...
  BootstrapTable.prototype.initToolbar = function () {
    ...
    if (this.options.showColumns) {
      html.push(sprintf('<div class="btn-group show-columns" title="%s">',
            ...
            ' </button>',
            '',
              '<div id="columnMenu" class="keep-open dropdown-menu column-count bss-ddm-overide insert-b-a" aria-labelledby="dropdownMenuLink" role="menu">')
      ...
      $.each(this.columns, (i, column) => {
        ...
        var uniqueIDName = '_' + column.field + '-' + i
